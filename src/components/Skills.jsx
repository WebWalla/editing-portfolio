        ...
        {skillCards.map((card, index) => {
          ...
          return (
            <motion.article
              ...
              className="group relative overflow-hidden rounded-[1.5rem] border border-white/10 bg-[#0d0d0d] p-6 transition hover:border-[#FFB000]/60 hover:shadow-[0_0_30px_rgba(255,176,0,0.12)]"
            >

        ...
        {toolsList.map((tool, index) => {
          return (
            <motion.div
              ...
              className="rounded-[1.5rem] border border-white/10 bg-[#0c0c0c] p-5 transition hover:-translate-y-1 hover:border-[#FFB000]/50 hover:bg-[#101010]"
            >
              ...
              <div className="text-xl font-bold tracking-[-0.05em] text-white">{tool.name}</div>
              <div className="mt-2 text-sm text-white/60">{tool.purpose}</div>
            </motion.div>
          )
        })}
      </div>
